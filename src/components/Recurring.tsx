    ...
    <div>
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 rounded-lg border border-hairline bg-surface px-2.5 py-1.5 text-sm outline-none focus:border-pigment"
        />
      ...
      <div className="mt-2 divide-y divide-shade rounded-xl border border-hairline bg-surface">
        ...
        {!held.length && (
          <p className="px-3 py-2.5 text-[12px] text-muted">{t('Nothing repeats yet.')}</p>
        )}
      </div>
    </div>
  )
