    ...
    <Popover
      ...
      trigger={({ toggle }) => (
        <button
          type="button"
          onClick={toggle}
          className="mb-4 flex w-full items-center gap-1.5 rounded-lg border border-[#E2DED5] bg-[#FCFBF8] px-2 py-1.5 text-left text-[13px] font-semibold text-[#141310] transition-colors hover:border-[#C8452D]"
        >
          {here
          ...
          <ChevronsUpDown size={13} className="shrink-0 text-[#8A867C]" />
        </button>
      )}
    >
      {(close) => (
        <>
          <button
            ...
            className="flex w-full items-center gap-1.5 rounded-md px-2 py-1.5 text-left text-[13px] hover:bg-[#EAE6DD]"
          >
            <span aria-hidden className="h-2.5 w-2.5 shrink-0 rounded-[3px] bg-[#C6C2B6]" />
            <span className="min-w-0 flex-1 truncate">{t('Everything')}</span>
            {!scope && <Check size={13} className="shrink-0 text-[#C8452D]" />}
          </button>
          ...
          {rows.map((row) => (
            ...
            >
              ...
              {scope === row.id && <Check size={13} className="shrink-0 text-[#C8452D]" />}
            </button>
          ))}
          ...
          <button
            ...
            className="w-full rounded-md px-2 py-1.5 text-left text-[12px] font-semibold text-[#8A867C] hover:bg-[#EAE6DD] hover:text-[#C8452D]"
          >
